...
public class TeacherGradeUpdateDto {
    ...
    public TeacherGradeUpdateDto(int gradeId, int studentId, int subject_id, int t_id, int levelId, int period1Grade, int period2Grade) {
